...
parser.add_option("-e", "--end", default=1000e6, dest="fstop", help="Final frequency in scaling sweep [default: %default]")
...
for i in range(stepCount):
    ...
    f_id,voltage=recallFrequency(freq,options.fTable)
